  ...
  return (
    <div>
      <button
        ...
        class="flex items-center gap-2 border-2 border-gray-800 dark:border-gray-200 rounded-full px-5 py-1 font-semibold text-gray-800 hover:bg-gray-800 hover:text-white dark:text-gray-200 dark:hover:bg-gray-200 dark:hover:text-black transition-colors duration-300"
      >
        <IconCart size={20} />
...
function CartInner(props: { cart: CartData | undefined }) {
  ...
  const card =
    `py-8 px-6 h-full bg-white dark:bg-black ${corners} flex flex-col justify-between`;
  ...
  return (
    <div class={card}>
      <div class="flex justify-between">
        ...
        >
          <svg
            class="w-6 h-6 fill-current text-gray-600 dark:text-gray-400"
            viewBox="0 0 24 24"
        ...
        <div class="flex-grow-1 my-4">
          {props.cart.lines.nodes.length === 0
            ...
            : (
              <ul
                role="list"
                class="-my-6 divide-y divide-gray-200 dark:divide-gray-800"
              >
      ...
      {props.cart && (
        <div class="border-t border-gray-200 dark:border-gray-800 py-6 px-4 sm:px-6">
          ...
          <div class="mt-6">
            <button
              type="button"
              class="w-full bg-accent border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:opacity-90"
          ...
          <div class="mt-6 flex justify-center text-center text-sm text-gray-600 dark:text-gray-400">
            <p>
              or&nbsp;
              <button
                type="button"
