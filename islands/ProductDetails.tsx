  ...
  return (
    <div class="w-11/12 max-w-5xl mx-auto mt-8 lg:grid lg:grid-cols-2 lg:gap-x-16">
      ...
      <div>
        <div class="flex flex-col gap-4">
          <div class="w-full flex items-center justify-between gap-4">
            <div>
              <h2 class="text-xl lg:!text-2xl font-semibold text-gray-800 dark:text-gray-200">
                {product.title}
              </h2>
            ...
            <div class="bg-accent rounded-full px-6 py-2 text-lg text-gray-900 dark:text-gray-100 font-bold">
        ...
        <section
          ...
          class="mt-12 pt-6 border-t-1 border-gray-200 dark:border-gray-800"
        >
          ...
          <div class="mt-4 space-y-6">
            <p
              class={tw`text-base text-gray-600 dark:text-gray-400 ${descriptionStyles}`}
      ...
      <div
        class={tw`${
          aspectRatio(1, 1)
        } w-full bg-white rounded-xl border-2 border-gray-200 dark:border-gray-800 mt-12 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-start`}
      >
      ...
      <div class="mt-12 lg:max-w-lg lg:col-start-1 lg:row-start-2 lg:self-start">
        <section aria-labelledby="options-heading">
          {product.variants.nodes.length > 1 && (
            <div class="group">
              <div class="relative p-4 flex items-center justify-between rounded-lg border-2 border-gray-300 dark:border-gray-700 group-hover:border-gray-400 dark:group-hover:border-gray-600 transition-colors">
